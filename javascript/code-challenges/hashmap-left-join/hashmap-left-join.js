function leftJoin(leftMap, rightMap, direction='left'){
  ...
  if(join === 'left'){
    ...
    // loop through our results array and check if rightMap has the key
    // if key is found, push the value in rightMap to our nested array at index[i]

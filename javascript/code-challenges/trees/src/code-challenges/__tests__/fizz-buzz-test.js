const {Tree, fizzBuzz} = require("../fizzBuzz/tree");
...
describe("FizzBuzzTree", () => {
  ...
  //   expect(fizzBuzz(fizzBuzzTree.preOrder())).toStrictEqual([
  //     1,
  //     [2],
  //     ["fizz", [4, ["buzz"], ["fizz"]], [7]],
  //     [8, ["fizz", ["buzz"], [11]], ["fizz"]],
  ...
  it('prints to the console', () => {
    const tree = new Tree(1, [new Tree(3)]);

    expect(tree.pOrder()).toStrictEqual([1]);
